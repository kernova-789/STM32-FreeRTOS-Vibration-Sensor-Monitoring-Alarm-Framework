...
add_library(Group_Application_User_Core OBJECT
  ...
  "${SOLUTION_ROOT}/../Core/Src/boot_can.c"
  "${SOLUTION_ROOT}/../Core/Src/boot_flash.c"
  "${SOLUTION_ROOT}/../Core/Src/boot_app.c"
  "${SOLUTION_ROOT}/../Core/Src/boot_ui.c"
  "${SOLUTION_ROOT}/../Core/Src/boot_hardware.c"
  ...
  "${SOLUTION_ROOT}/../Core/Src/stm32f1xx_hal_timebase_tim.c"
  "${SOLUTION_ROOT}/../Core/Src/screen.c"
)
...
add_library(Group_Drivers_STM32F1xx_HAL_Driver OBJECT
  ...
  "${SOLUTION_ROOT}/../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_can.c"
